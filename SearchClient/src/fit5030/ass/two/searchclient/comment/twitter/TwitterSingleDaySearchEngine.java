...
public class TwitterSingleDaySearchEngine
	...
	@Override
	public SingleDaySocialSearchResult search(SingleDaySocialSearchQuery query) {

		SingleDaySocialSearchResult result = new SingleDaySocialSearchResult();
...
//				System.out.println("paqe=" + page);
				if (nl.getLength() >= 1) {
					result.setTrend(100 * (page - 1) + nl.getLength());
					break;
				}
